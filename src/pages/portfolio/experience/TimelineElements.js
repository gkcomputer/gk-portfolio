let protimelineElements = [
  ...
  },
  {
    ...
    title: "Software Engineer",
    location: "KEYSTACK",
    company: "HP PRINT SERVICES",
    description:
      "HP printers and services project aimed to create a comprehensive platform       that offered a wide range of printer-related services, encompassing troubleshooting, printing, computing, software, and driver support.",
    buttonText: "",
